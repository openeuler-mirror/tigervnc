...
Provides:  	%{name}-icons = %{name}-%{release}
Obsoletes: 	%{name}-icons < %{name}-%{release}
...
%changelog
* Mon Feb 14 2022 quanhongfei <quanhongfei@h-partners.com> - 1.12.0-3
- Type:bugfix
- ID:NA
- SUG:NA
- DESC:tigervnc does not provide tigervnc-license
